...
#[ApiResource(
    ...
    collectionOperations: [
        ...
        'post' => [
            ...
            // 'validation_groups' => ['Default', 'page_create'],

        ]
    ],
    itemOperations: [
        'get' => [
            'normalization_context' => ['groups' => ["page:read", "page:item:get"]],
            'security' => "is_granted('PUBLIC_ACCESS')"
        ...
        'post' => [
            ...
            'openapi_context' => [
                'summary' => ' Update a Page resource ',
                'description' => ' Update a Page resource ',
                'requestBody' => [
                    'content' => [
                        'multipart/form-data' => [
                            'schema' => [
...
class Page
{
    ...
    #[Groups(["page:write", "page:item:get"])]
    #[Assert\NotBlank()]
    private $content;
